...
*************************************************************************************/
inline void CSommet::SOMAjouterArcArrivant(CArc & ARCParam)
{
	...
	/* On ajoute ARCParam a la liste */
	NouveauxArcs[uiSOMNombreArcsArrivants] = &ARCParam;
...
************************************************************************************/
inline void CSommet::SOMSupprimerArcArrivant(CArc & ARCParam)
{
	...
	unsigned int uiIndiceArcArrivant = GEARechercherIndiceArcArrivant(ARCParam.ARCLireNumeroDestination());
	if (uiIndiceArcArrivant == EXC_ARC_INEXISTANT)
	{
