...
class CSommet
{
	...
	public:
		...
		*********************************************************************************************
		***** Entree: unsigned int uiNumeroSommet, unsigned int uiNumeroCouleur = 0				*****
		***** Necessite: (rien)																	*****
		***** Sortie: (rien)																	*****
		***** Entraine : cree un sommet de numero "uiNumero" et de couleur "uiNumeroCouleur"	*****
		********************************************************************************************/
		CSommet(unsigned int uiNumeroSommet, unsigned int uiNumeroCouleur = 0);
		...
		***** Necessite: uiIndice < uiSOMNombreArcsArrivants								*****
		...
		*****************************************************************************************
		***** Entree: unsigned int uiIndice												    *****
		***** Necessite: uiSOMNombreArcsPartants										    *****
		...
		***** Entraine : renvoie GCSSOMGestionCouleur par reference						    *****
		****************************************************************************************/
