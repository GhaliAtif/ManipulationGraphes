...
int main(int argc, char *argv[])
{
	...
	try
	{
		...
		GRAGraphe.GEGAfficherGrapheNonOriente();
		...
		{
			cout << "Le graphe cree a partir du fichier texte peut etre colorie comme detaille dans l'enonce. Voici une solution : " << endl << endl;
			GRAGraphe.GEGAfficherSolutionColoration();
		}
